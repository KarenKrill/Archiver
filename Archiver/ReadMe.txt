========================================================================
    ПРИЛОЖЕНИЕ : Обзор проекта КурсоваяРабота(архиватор)
========================================================================

Это приложение КурсоваяРабота(архиватор) создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения КурсоваяРабота(архиватор).

КурсоваяРабота(архиватор).vcxproj
...
КурсоваяРабота(архиватор).vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем КурсоваяРабота(архиватор).pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
